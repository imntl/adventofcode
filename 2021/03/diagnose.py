...
if __name__ == '__main__':
    ...
    print(f"The power consuption is {gamma * epsilon} with rates {gamma} and {epsilon}.")
    ...
    print(f"The life support rating is {oxygen * scrubber} with rates {oxygen} and {scrubber}.")
